...
// --- Fonctions d'Icônes ---
const FacultyIcon = () => <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M12 14l9-5-9-5-9 5 9 5zm0 0l-9 5 9 5 9-5-9-5z" /></svg>
const DeptIcon = () => <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 text-green-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M8 14v3m4-3v3m4-3v3M3 21h18M5 10h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v3a2 2 0 002 2zm1 0h12v3H6v-3z" /></svg>
const ProgramIcon = () => <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 text-purple-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg>
// ----------------------------
                ...
                <div className="px-6 py-12">
                    ...
                    <div className="mb-8 text-center">
                        ...
                        <p className="text-lg text-gray-600">
                            ...
                            {currentStep === 2 && `Départements de la faculté ${selectedFaculty ? selectedFaculty.name : ''}.`}
                            {currentStep === 3 && `Programmes du département ${selectedDepartment ? selectedDepartment.name : ''}.`}
                                ...
                                >
                                    <div className="flex items-center">
                                        ...
                                        <div className="flex-grow">
                                            <div className="font-bold text-lg text-gray-900 mb-1">{faculty.name}</div>
                                            <div className="text-sm text-gray-500">{faculty.departments.length} départements</div>
                                        </div>
                                ...
                                >
                                    <div className="flex items-center">
                                        ...
                                        <div className="flex-grow">
                                            ...
                                            <div className="text-sm text-gray-500">{dept.programs.length} programmes</div>
                                        </div>
                                        <span className="text-gray-500 font-bold ml-4">→</span>
                                    </div>
                                </button>
                    ...
                    {currentStep === 4 && (
                        <div>
                            ...
                            <div className="overflow-x-auto bg-white">
                                <table className="min-w-full divide-y divide-gray-200 border border-gray-300"> {/* Conserver une bordure externe légère */}
                                    
                                    {/* En-têtes des jours */}
                                    <thead className="bg-gray-50">
                                        <tr>
                                            <th className="px-3 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider border-r border-gray-300 w-1/12">Heure</th>
                                    ...
                                    <tbody className="divide-y divide-gray-200">
                                        {['08:00 - 10:00', '10:00 - 12:00', '13:00 - 15:00', '15:00 - 17:00'].map((time, timeIdx) => (
                                            <tr key={timeIdx} className="hover:bg-blue-50 transition-colors">
                                                <td className="px-3 py-3 whitespace-nowrap text-sm font-medium text-gray-700 bg-gray-50 border-r border-gray-300">{time}</td>
